...
namespace DevNote
{
    public interface IPurchaseHandler
    {
        ...
        public static bool ProductIsConsumable(ProductKey productKey) => !_handler.PermanentProducts.Contains(productKey);


        protected abstract void HandlePurchase(ProductKey productKey);
        protected abstract List<ProductKey> PermanentProducts { get; }
